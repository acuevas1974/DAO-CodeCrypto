export const daoVotingAbi = [
  ...
  { inputs: [{ name: "recipient", type: "address", internalType: "address" }, { name: "amount", type: "uint256", internalType: "uint256" }, { name: "deadline", type: "uint256", internalType: "uint256" }], name: "createProposal", outputs: [{ name: "proposalId", type: "uint256", internalType: "uint256" }], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ name: "proposalId", type: "uint256", internalType: "uint256" }], name: "getProposal", outputs: [{ name: "", type: "tuple", internalType: "struct DAOVoting.Proposal", components: [{ name: "id", type: "uint256" }, { name: "amount", type: "uint256" }, { name: "recipient", type: "address" }, { name: "deadline", type: "uint256" }, { name: "forVotes", type: "uint256" }, { name: "againstVotes", type: "uint256" }, { name: "abstainVotes", type: "uint256" }, { name: "status", type: "uint8" }] }], stateMutability: "view", type: "function" },
...
export type Proposal = { id: bigint; amount: bigint; recipient: `0x${string}`; deadline: bigint; forVotes: bigint; againstVotes: bigint; abstainVotes: bigint; status: 0 | 1 | 2 | 3 };
